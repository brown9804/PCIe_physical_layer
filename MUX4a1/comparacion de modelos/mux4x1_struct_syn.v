...
(* src = "ff2in2o.v:8" *)
module ff2in2o(clk, reset, in0, in1, out0, out1);
  (* src = "ff2in2o.v:19" *)
  wire [7:0] _00_;
  (* src = "ff2in2o.v:19" *)
  wire [7:0] _01_;
...
(* src = "ff4in4o.v:8" *)
module ff4in4o(clk, reset, in0, in1, in2, in3, out0, out1, out2, out3);
  (* src = "ff4in4o.v:23" *)
  wire [7:0] _00_;
  (* src = "ff4in4o.v:23" *)
  wire [7:0] _01_;
...
module mux2x1_behav(clk, in0, in1, valid, reset, out, validout);
  ...
  output validout;
  assign validout = selector ? (* src = "mux2x1_behav.v:52" *) valid[1] : valid[0];
