...
module mux4x1_behav_syn(clk1f, clk2f, clk4f, reset, in0, in1, in2, in3, valid, out, validout);
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "./src/mux4x1_behav_syn.v:106" *)
  ff2in2o_syn ff42 (
    .clkf(clk2f),
    .in0(n4),
    .in1(n5),
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "./src/mux4x1_behav_syn.v:115" *)
  ...
  (* module_not_derived = 32'd1 *)
  (* src = "./src/mux4x1_behav_syn.v:128" *)
...
(* top =  1  *)
(* src = "./src/phy_tx.v:16" *)
module phy_tx_b_syn(clk1f, clk2f, clk4f, clk32f, reset, in0, in1, in2, in3, in_rx_tx, validmux41, out0_recir, out1_recir, out2_recir, out3_recir, valid_out_recir, out_b);
  (* src = "./src/phy_tx.v:48" *)
  wire active_inter;
  (* src = "./src/phy_tx.v:18" *)
  input clk1f;
...
module serieparalelo_IDLE_syn(in, clk32f, clk4f, reset, valido);
